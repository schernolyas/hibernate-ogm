...
public class IgniteSqlQueryParser {
	...
	public String process() {
		String processedSql = substituteBrackets( originalQuery );
	...
	/**
	 * Substitues JDBC parameter placeholders (?) for all encountered parameter specifications. It also tracks the
	 * positions of these parameter specifications within the query string. This accounts for ordinal-params,
	 * named-params, and ejb3-positional-params.
	 *
