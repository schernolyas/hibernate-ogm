...
@SkipByGridDialect(value = { GridDialectType.CASSANDRA,
		GridDialectType.ORIENTDB }, comment = "Bag semantics not supported by Cassandra backend. "
				+ "OrientDB not supports table like 'StoryGame_evilBranch.additionalEndings'")
